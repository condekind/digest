...
pub fn get_common_test_structure() -> TestDirectoryStructure {
    TestDirectoryStructure {
        files: vec![
            ...
            ("src/utils/helpers.rs".to_string(), "pub fn helper() {}".to_string()),
            
            // Test files
            ("src/tests/test_main.rs".to_string(), "#[test] fn test() {}".to_string()),
            ("tests/integration/mod.rs".to_string(), "pub mod tests;".to_string()),
            ("tests/unit/test_utils.rs".to_string(), "#[test] fn test_utils() {}".to_string()),
            
            // Documentation
            ("docs/README.md".to_string(), "# Documentation".to_string()),
            ("src/lib/README.md".to_string(), "# Library README".to_string()),
            ...
            // Dependencies
            ("node_modules/package/index.js".to_string(), "module.exports = {}".to_string()),
        ...
        description: "Common project structure with source, tests, docs, build artifacts".to_string(),
    }
}
...
pub fn get_common_test_cases() -> Vec<IgnorePatternTestCase> {
    vec![
        ...
        IgnorePatternTestCase {
            ...
            digestignore_patterns: vec![
                "# Digestignore comment".to_string(),
                "docs/".to_string(),
            ],
            expected_included: vec![
                "src/main.rs".to_string(), 
